...
def load_data():
    ...
    df_agg['Engagement_ratio'] = (df_agg['Comments added'] + df_agg['Shares'] + df_agg['Dis­likes'] + df_agg['Likes']) / df_agg['Views']
...
# load data: create dataframe from the function
...
# What metrics will be ralavant?
# create differernces from the median for values
...
if add_sidebar == 'Individual Video Analysis':
    ...
    agg_time_filtered = df_time_diff[df_time_diff['Video publish time'] == video_select]
